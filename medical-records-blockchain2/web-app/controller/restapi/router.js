...
router.post('/fabric/client/getMyRequests*', hlcClient.getMyRequests);
router.post('/fabric/client/addRequest*', hlcClient.addRequest);
router.post('/fabric/client/requestAction*', hlcClient.requestAction);