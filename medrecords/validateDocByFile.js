/* Validate the document in the notarization app.
    Proves that:
        -doc. has been recorded in the ledger before
        -sig. is corect and created by cert. provided
        -cert. provided is valid cert. by a CA
        -time when rec. created
    Receives valid user wallet, filename, and cert fo file owner
